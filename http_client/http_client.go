...
// Package http_client provides additional resiliency over the standard http client methods by
...
//ErrUnexpectedMethod occurs when an http.Client method is unable to be mapped from a calling method in the http_client client
...
// Additionally, Client provides http_client specific values for handling resiliency.
type Client struct {
...
// params represents all the params needed to run http client calls and http_client errors
type params struct {
	method   string
	verb     string
	req      *http.Request
...
// and extends it to have http_client's features of concurrency and retries.
...
// Wait blocks until all http_client requests have returned
...
// http_client provides all the logic of retries, concurrency, backoff, and logging
func (c *Client) http_client(p params) (*http.Response, error) {
...
// EmbedHTTPClient allows you to extend an existing http_client client with an
...
func (c *Client) Do(req *http.Request) (resp *http.Response, err error) {
	return c.http_client(params{method: methodDo, req: req, verb: req.Method, url: req.URL.String()})
}

// Get provides the same functionality as http.Client.Get
func (c *Client) Get(url string) (resp *http.Response, err error) {
	return c.http_client(params{method: methodGet, url: url, verb: http.MethodGet})
}

// Head provides the same functionality as http.Client.Head
func (c *Client) Head(url string) (resp *http.Response, err error) {
	return c.http_client(params{method: methodHead, url: url, verb: http.MethodHead})
}

// Post provides the same functionality as http.Client.Post
func (c *Client) Post(url string, bodyType string, body io.Reader) (resp *http.Response, err error) {
	return c.http_client(params{method: methodPost, url: url, bodyType: bodyType, body: ioutil.NopCloser(body), verb: http.MethodPost})
}

// PostForm provides the same functionality as http.Client.PostForm
func (c *Client) PostForm(url string, data url.Values) (resp *http.Response, err error) {
	return c.http_client(params{method: methodPostForm, url: url, bodyType: contentTypeFormURLEncoded, body: ioutil.NopCloser(strings.NewReader(data.Encode())), verb: http.MethodPost})
}
